...
Vec3 FresnelDielectric::eval(float cos_theta, const intersection& p) const {
    bool is_inside = !p.is_front; // “üËƒŒƒC‚ª”}¿‚Ì“à‘¤‚É‚ ‚é‚©”»’è
...
* @param[in]  line      :‹æØ‚è‚½‚¢•¶š—ñ
* @param[in]  delimiter :‹æØ‚è•¶š
* @return std::vector<std::string> •¶š—ñ”z—ñ
* @note TODO: Triangle.cpp‚Æ“¯‚¶‚È‚Ì‚ÅŒã‚Å“ˆê‚·‚é
*/
